...
app.controller('MagnetController', function($http, $scope){
   	...
   	$http.get('/static/research/js/exec-magnets/pubexecpay2013.json').success(function(data) {
  		viz.data = data;
	  	});
  	});
...
app.directive('magnet', function(){
  	...
  	function link(scope, el, attr){
		...
		var tipPoint = d3.tip()
		  ...
		  .html(function(d) {
		  	...
		  	tip += "Base pay: $" + d.data.BasePay + "</br>";
  	...
  	return {
  		...
  		templateUrl: '/static/research/js/exec-magnets/magnet.html'
  	}
  });
})();
